...
exports.createResponse = exports.parseBody = exports.checkRequestMethod = exports.AWSHandler = void 0;
...
exports.AWSHandler = (requestMethod, callback) => {
    return (event) => __awaiter(void 0, void 0, void 0, function* () {
        exports.checkRequestMethod(requestMethod, event);
        return yield callback(event);
    });
};
exports.checkRequestMethod = (requestMethod, event) => {
